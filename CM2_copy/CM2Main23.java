        ...
        do {
            ...
            switch (pilihan) {
                case 1: {
                    ...
                    if (antrian.size() >= 2){
                        System.out.print("Antrian prioritas atau biasa?(p/b): ");
                        String konfirmasi = sc.nextLine();
                        if (konfirmasi.equalsIgnoreCase("p")){
                            int noAntrian = 2;
                            Pembeli23 pembeliBaru = new Pembeli23(noAntrian, nama, noHp);
                            antrian.tambahAntrianPrioritas(1, pembeliBaru);
                            antrian.hapusAntrianBelakang();
                        }
                    }
                    break;
                }
